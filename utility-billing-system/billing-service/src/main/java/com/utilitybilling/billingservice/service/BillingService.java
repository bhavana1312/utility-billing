...
public class BillingService {
    ...
    public BillResponse generate(GenerateBillRequest request) {
        ...
        double previousReading = billRepo
                .findTopByMeterNumberOrderByGeneratedAtDesc(request.getMeterNumber())
        ...
        notificationClient.send(
                NotificationRequest.builder()
                        ...
                        .message(
                                "Your " + bill.getUtilityType() + " bill has been generated.\n\n" +
                                        "Bill ID: " + savedBill.getId() + "\n" +
    ...
    public Page<BillResponse> consumerBills(String consumerId, int page, int size) {
        return billRepo
                .findByConsumerIdOrderByGeneratedAtDesc(
                        consumerId,
    ...
    public Page<BillResponse> all(BillStatus status, int page, int size) {
        ...
        return (status == null ? billRepo.findAll(pageable) : billRepo.findByStatus(status, pageable))
                .map(this::map);
    }
    ...
    private BigDecimal calculateEnergyCharge(double units, Iterable<TariffSlab> slabs) {
        ...
        for (TariffSlab slab : slabs) {
            ...
            BigDecimal slabCharge = BigDecimal.valueOf(used)
                    .multiply(BigDecimal.valueOf(slab.getRatePerUnit()));
